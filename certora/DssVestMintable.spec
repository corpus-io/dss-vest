...
rule rely_revert(address usr) {
    ...
    uint256 ward = wards(getMsgSender(e));
...
rule vest_revert(uint256 _id) {
    ...
    bool revert3  = usr == 0;
    bool revert4  = res != 0 && usr != getMsgSender(e);
...
rule restrict_revert(uint256 _id) {
    ...
    bool revert2 = locked != 0;
    bool revert3 = _usr == 0;
    bool revert4 = ward != 1 && _usr != getMsgSender(e);
...
rule yank_revert(uint256 _id) {
    ...
    bool revert1 = e.msg.value > 0;
    bool revert2 = locked != 0;
    bool revert3 = ward != 1 && mgr != getMsgSender(e);
    bool revert4 = usr == 0;
...
rule move_revert(uint256 _id, address _dst) {
    ...
    bool revert1 = e.msg.value > 0;
    bool revert2 = locked != 0;
    bool revert3 = _usr != getMsgSender(e);
    bool revert4 = _dst == 0;
